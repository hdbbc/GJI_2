...
for i=0:1:99
    ...
    TS5EySyn(Dataspan1)=TS5EySyn(Dataspan1)+MTSynNoise;
    TS5ExSyn(Dataspan1)=TS5ExSyn(Dataspan1)+MTSynNoise;
figure(3)
    hold on
    plot(TS5EX,'g');
    plot(TS5ExSyn,'r');
...
%  Save the noisy data
    fids1 = fopen('QH401504TS5EXSynData.dat', 'wt');
    fprintf(fids1, '%10.0f%10.0f', TS5ExSyn);
    fclose(fids1);
    fids1 = fopen('QH401504TS5EYSynData.dat', 'wt');
