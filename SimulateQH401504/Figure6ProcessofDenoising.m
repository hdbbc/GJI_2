tic
 ...
 clc;
    ...
    MTOriginal=MTOriginal(334501:339000);
    MTMMFSVMKSVD=load('QH401504TS5EYMMFSVMKSVD.dat');
    MTMMFSVMKSVD=MTMMFSVMKSVD(334501:339000);
    RawMT=load('QH401504TS5EYSynData.dat'); 
    RawMT=RawMT(334501:339000);
    average=sum(RawMT)/length(RawMT);
    RawMT=RawMT-average;
    MTOriginal=MTOriginal-average;
    fs=15;
    N=150;
    Length=length(RawMT);
    k=30;
...
%%高质量信号与噪声信号
   ...
   figure(4)
     subplot(711);
     plot(t,MTOriginal);legend('Original');
     set(gca,'FontName','Times New Roman','FontSize',10);ylabel('Amplitude');
     subplot(712);
     plot(t,RawMT);legend('Noisy');
     set(gca,'FontName','Times New Roman','FontSize',10);ylabel('Amplitude');
     subplot(713);
     plot(t,MT_MMF);legend('Low');
     set(gca,'FontName','Times New Roman','FontSize',10);ylabel('Amplitude');
     subplot(714);
     plot(t,x);legend('High');
     set(gca,'FontName','Times New Roman','FontSize',10);xlabel('Time(s)');ylabel('Amplitude');
     subplot(717);
     plot(t,MTMMFSVMKSVD);legend('MMFSVMKSVD');
     set(gca,'FontName','Times New Roman','FontSize',10);xlabel('Time(s)');ylabel('Amplitude');
     a=zeros(1,4500);
     b=zeros(1,4500);
     for i=1:k
